...
function doGetValue(name)
{
	...
	else
	{
		...
		if (errCode != _NoError)
		{
			ErrorHandler("GetValue("+name+") failed. \n"+ errDescription);
			return errCode;
		}
		else
		{
...
function doSetValue(name, value)
{
   ...
   else
   {
      ...
      if (result.toString() != "true") ErrorHandler('doSetValue('+name+','+value+')');
   }
...
function ErrorHandler(origen)
{
   ...
   if (errCode != _NoError)
   {
      ...
      var errDescription = "LMS Error: "+origen+": ErrorCode=" + errCode + "\n Desc:";
...
function getAPI()
{
	...
	estado_api = "<font color='#009900'>La comunicaci�n con el API se ha realizado correctamente</font><br/><br/><font size='16'>Encontrado en la ventana lanzadora</font>";
			...
			(typeof(window.opener) != "undefined") )
	{
		...
		estado_api = "<font color='#009900'>La comunicaci�n con el API se ha realizado correctamente</font><br/><br/><font size='16'>Encontrado en el opener</font>";
	}
	if (	(theAPI == null) &&
			...
			(typeof(window.top.opener) != "undefined") )
	{
		...
		estado_api = "<font color='#009900'>La comunicaci�n con el API se ha realizado correctamente</font><br/><br/><font size='16'>Encontrado en 3er nivel</font>";
	}
